...
import { EndpointResponse, EndpointSpec, EndpointOfPath } from './routes'

export class TypedFetcher<TSpec extends EndpointSpec> {
	constructor(public host: string) {}

	request<P extends keyof TSpec, T extends EndpointOfPath<TSpec, P>>(path: P, method: T['method']): Fetcher<T['response']> {
...
export class Fetcher<R extends EndpointResponse> {
	...
	constructor(
		...
		public options: RequestInit & { fetch?: typeof fetch } = {}) {
